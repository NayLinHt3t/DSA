...
//To create SinglelyLinkedList
//A series of node must be connected in one direction
//we use pointer variables "head" for the first Node and "tail" for the last node
//
